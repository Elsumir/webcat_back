...
(function (exports,ui_vue3,main_core) {
        ...
        return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                if (_this.editName.trim() && _this.editPosition.trim() && _this.editExperience >= 0) {
                  _this.isEditing = false;
                  _this.$emit('edit', {
                    id: +_this.item.ID,
                    name: _this.editName,
                    position: _this.editPosition,
                    experience: _this.editExperience
                  });
                }
              case 1:
              case "end":
  ...
  var TaskManger = {
    ...
    data: function data() {
      return {
        ...
        items: [],
        id: 0,
        apiUrl: 'http://serikavj.beget.tech/rest/1/afy8tjyxkpe1jy4u/employee.list.'
      };
    },
    methods: {
      addItem: function addItem() {
        ...
        return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee() {
          var name, position, experience, data, options;
          return _regeneratorRuntime$1().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                if (!(_this.newItem.name.trim() && _this.newItem.position.trim() && _this.newItem.experience >= 0)) {
                  _context.next = 14;
                  break;
                }
                name = _this.newItem.name;
                position = _this.newItem.position;
                experience = _this.newItem.experience;
                data = {
                  name: name,
                  position: position,
                ...
                _context.next = 8;
                return fetch(_this.apiUrl + 'addEmployee', options);
              case 8:
                _this.fetchGetEmployees();
                _this.newItem.name = '';
                _this.newItem.position = '';
                _this.newItem.experience = 0;
                _context.next = 15;
                break;
              case 14:
          ...
          return _regeneratorRuntime$1().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return fetch(_this2.apiUrl + 'deleteEmployee', options);
              case 3:
                _this2.fetchGetEmployees();
              case 4:
              case "end":
          ...
          return _regeneratorRuntime$1().wrap(function _callee3$(_context3) {
            while (1) switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return fetch(_this3.apiUrl + 'updateEmployee', options);
              case 3:
                _this3.fetchGetEmployees();
              case 4:
              case "end":
      ...
      fetchGetEmployees: function fetchGetEmployees() {
        var _this4 = this;
        return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime$1().mark(function _callee4() {
          ...
          return _regeneratorRuntime$1().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 3;
                return fetch(_this4.apiUrl + 'getEmployees').then(function (res) {
                  return res.json();
                });
              case 3:
                response = _context4.sent;
                console.log(response.result);
                _this4.items = response.result;
              case 6:
              case "end":
  ...
  var Newtest = /*#__PURE__*/function () {
    function Newtest(rootNode) {
      babelHelpers.classCallCheck(this, Newtest);
    ...
    babelHelpers.createClass(Newtest, [{
      key: "start",
      ...
      value: function attachTemplate() {
        babelHelpers.classPrivateFieldSet(this, _application, BX.Vue3.createApp({
          name: 'TaskManager',
          components: {
        ...
        babelHelpers.classPrivateFieldGet(this, _application).use(BX.Vue3.BitrixVue);
...
}((this.BX.Local = this.BX.Local || {}),BX,BX));
